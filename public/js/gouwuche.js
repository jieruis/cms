...
var qiehuan3 = document.querySelector("#tu3");
var qiehuan4 = document.querySelector("#tu4");
var qiehuan5 = document.querySelector("#tu5");
qiehuan.onclick=function(){
abc.src="./images/img516.webp";
};
qiehuan2.onclick=function(){
    abc.src="./images/img517.webp";
}
qiehuan3.onclick=function(){
    abc.src="./images/img518.webp";
}
qiehuan4.onclick=function(){
    abc.src="./images/img519.webp";
}
qiehuan5.onclick=function(){
    abc.src="./images/img5110.webp";
}
// 加减数量
var str =1;
var yuan = 69.00;
